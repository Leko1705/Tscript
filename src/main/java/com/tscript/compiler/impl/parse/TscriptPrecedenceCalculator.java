...
public final class TscriptPrecedenceCalculator {
    ...
    public static TCTree.TCExpressionTree apply(TreeMaker factory, Token<TscriptTokenType> op, TCTree.TCExpressionTree lhs, TCTree.TCExpressionTree rhs) {
        TscriptTokenType tag = op.getTag();
        return switch (tag) {
